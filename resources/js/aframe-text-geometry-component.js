...
/***/ function(module, exports) {
	...
	AFRAME.registerComponent('text-geometry', {
	  schema: {
	    ...
	    font: {type: 'asset', default: '/ARTest/resources/fonts/NanumGothic.json'},
		...
		// http://localhost:8080/resources/fonts/NanumGothic.json

		// http://vrar.tplinkdns.com:8080/resources/fonts/NanumGothic.json
	  /**
