...
var KEvent = {
    ...
    broadcast : function(targetEventName) {
		console.log(targetEventName);
        document.querySelector('a-scene').emit('broadcast', {eventName : targetEventName}, false);
    },
    call : function(targetEventName) {
		...
		for(var i = 0 ; i < CustomComponentList.length; i++) {
			var component = CustomComponentList[i];
			var componentName = component.componentName;

			// 컴포넌트로 오브젝트 찾기
			// var element =

			document.getAttribute("test").emit('eventlisten',{eventName : targetEventName}, false);
    ...
    componentCall : function(targetEventName) {
        ...
        for(var i = 0; i < CustomComponentList.length; i++){
            ...
            for(var j = 0; j < entities.length; j++){
                ...
                //console.log("id : " + entities[j].id);
                //var objEl =  document.querySelector("#" + entities[j].id);
                //console.log("obj id : " + objEl.id +" / obj type : " + typeof objEl + " / obj : " + objEl);
                //console.log("targetEventName : " + entities[j].id);
